...
In order to initialize an object with an `Occurrence` class, we must provide 2 arugments 1) a db connection and 2) the name of data table / view we're interested in pulling data from. For example,
